...
Текущий gate: независимое ревью `A-01`. После его принятия выполняется `A-02`; feature-карточки не начинаются до source reconciliation и актуализации audit findings.
