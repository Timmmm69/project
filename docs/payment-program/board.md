...
Текущий gate: correction finding `A02-DOC-HYGIENE-01` выполнен, A-02 повторно находится `IN_REVIEW`. Feature-карточки не начинаются до принятия A-02/A-04 и актуализации audit findings.
