...
B1-05 теперь `READY`; A-07 остаётся long-lived program-control `IN_PROGRESS`;
...
| [B1-05](tasks/B1-05.md) | B1 — Verified authority и recovery | Восстанавливать Existing Order/Access/Attempt/Result | `READY` | `CRITICAL` | `B1-03`, `B1-04` |
