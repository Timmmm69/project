...
Текущий feature milestone: B1-04 — `IN_REVIEW` на base SHA `dcf58d3`.
...
| [B1-04](tasks/B1-04.md) | B1 — Verified authority и recovery | Требовать verified email до Order | `IN_REVIEW` | `CRITICAL` | `B1-01`, `B1-03` |
