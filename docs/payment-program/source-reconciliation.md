...
| `SRC-PAY-03` | README; E-POS report; WebPay smoke docs | A-05 пометила E-POS report historical/superseded, README направила на WEBPAY target, а smoke docs — local/assumed evidence; изменения ожидают независимого review | Program governance / Payments | `A-05` | Ни один sandbox document не является merchant-approved protocol; production `NO-GO` |
